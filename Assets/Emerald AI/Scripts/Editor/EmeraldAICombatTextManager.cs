...
namespace EmeraldAI.Utility
{
    public class EmeraldAICombatTextManager : EditorWindow
    {
        ...
        protected virtual void OnEnable()
        {
            ...
            PlayerOnly = serializedObject.FindProperty("PlayerOnly");
        ...
        void OnGUI()
        {
            ...
            if (CurrentTab == 0)
            {
                ...
                EditorGUILayout.PropertyField(PlayerOnly, new GUIContent("Combat Text Player Only"));
                GUI.backgroundColor = new Color(0.1f, 0.1f, 0.1f, 0.19f);
                EditorGUILayout.LabelField("Controls the whether the Combat Text System will only be displayed by player damage.", EditorStyles.helpBox);
                GUI.backgroundColor = Color.white;
                EditorGUILayout.Space();
                ...
                CustomEditorProperties.CustomIntSlider(new Rect(), new GUIContent(), FontSize, "Font Size", 10, 30);
                GUI.backgroundColor = new Color(0.1f, 0.1f, 0.1f, 0.19f);
